...
buildcuda:
	rm -f libvship.a
	nvcc -x cu src/VshipLib.cpp -ccbin $(CXX) -allow-unsupported-compiler $(CXXFLAGS) $(CUDAFLAGS) -arch=native --use_fast_math --extra-device-vectorization $(addprefix -Xcompiler ,$(HOSTFLAGS)) -lib -o libvship.a
