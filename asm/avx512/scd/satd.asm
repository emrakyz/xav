...
SECTION .text
INIT_ZMM avx512
cglobal satd8x8_x8, 4, 8, 16, src, ss, dst, ds, src4, dst4, ss3, ds3
    lea     ss3q, [ssq*3]
    lea     ds3q, [dsq*3]
    ...
    vpmovzxbw zmm0, [srcq]
    vpmovzxbw zmm9, [dstq]
    vpsubw    zmm0, zmm0, zmm9
    vpmovzxbw zmm1, [srcq+ssq]
    vpmovzxbw zmm9, [dstq+dsq]
    vpsubw    zmm1, zmm1, zmm9
    vpmovzxbw zmm2, [srcq+ssq*2]
    vpmovzxbw zmm9, [dstq+dsq*2]
    vpsubw    zmm2, zmm2, zmm9
    vpmovzxbw zmm3, [srcq+ss3q]
    vpmovzxbw zmm9, [dstq+ds3q]
    vpsubw    zmm3, zmm3, zmm9
    vpmovzxbw zmm4, [src4q]
    vpmovzxbw zmm9, [dst4q]
    vpsubw    zmm4, zmm4, zmm9
    vpmovzxbw zmm5, [src4q+ssq]
    vpmovzxbw zmm9, [dst4q+dsq]
    vpsubw    zmm5, zmm5, zmm9
    vpmovzxbw zmm6, [src4q+ssq*2]
    vpmovzxbw zmm9, [dst4q+dsq*2]
    vpsubw    zmm6, zmm6, zmm9
    vpmovzxbw zmm7, [src4q+ss3q]
    vpmovzxbw zmm9, [dst4q+ds3q]
    vpsubw    zmm7, zmm7, zmm9
    vpmovzxbw zmm16, [srcq+32]
    vpmovzxbw zmm25, [dstq+32]
    vpsubw    zmm16, zmm16, zmm25
    vpmovzxbw zmm17, [srcq+ssq+32]
    vpmovzxbw zmm25, [dstq+dsq+32]
    vpsubw    zmm17, zmm17, zmm25
    vpmovzxbw zmm18, [srcq+ssq*2+32]
    vpmovzxbw zmm25, [dstq+dsq*2+32]
    vpsubw    zmm18, zmm18, zmm25
    vpmovzxbw zmm19, [srcq+ss3q+32]
    vpmovzxbw zmm25, [dstq+ds3q+32]
    vpsubw    zmm19, zmm19, zmm25
    vpmovzxbw zmm20, [src4q+32]
    vpmovzxbw zmm25, [dst4q+32]
    vpsubw    zmm20, zmm20, zmm25
    vpmovzxbw zmm21, [src4q+ssq+32]
    vpmovzxbw zmm25, [dst4q+dsq+32]
    vpsubw    zmm21, zmm21, zmm25
    vpmovzxbw zmm22, [src4q+ssq*2+32]
    vpmovzxbw zmm25, [dst4q+dsq*2+32]
    vpsubw    zmm22, zmm22, zmm25
    vpmovzxbw zmm23, [src4q+ss3q+32]
    vpmovzxbw zmm25, [dst4q+ds3q+32]
    vpsubw    zmm23, zmm23, zmm25
