...
cglobal powf32, 0, 0, 6
    ...
    vgetexpss    xmm2, xmm0, xmm0
    vpor         xmm4, xmm3, [h32]
    vpcmpgtd     xmm0, xmm3, [s2f32]
    vpternlogd   xmm4, xmm0, [b23], 0xF2
    vmovss       xmm3, [one32]
    ...
    vrndscaless  xmm3, xmm5, xmm5, 8
    vreducess    xmm5, xmm5, xmm5, 8
    vmulss       xmm5, xmm5, [ln232]
    vmulss       xmm2, xmm5, xmm5
    vmovss       xmm0, [e5]
    vfmadd213ss  xmm0, xmm5, [e4]
    vmovss       xmm4, [e3]
    vfmadd213ss  xmm4, xmm5, [h32]
    vfmadd213ss  xmm0, xmm2, xmm4
    vaddss       xmm5, xmm5, [one32]
    vfmadd213ss  xmm0, xmm2, xmm5
    vscalefss    xmm0, xmm0, xmm3
    RET

cglobal log10, 0, 0, 6
    vpand        xmm1, xmm0, [fmask]
    vgetexpsd    xmm2, xmm0, xmm0
    vpor         xmm3, xmm1, [half]
    vpcmpgtq     xmm1, xmm1, [s2frac]
    vpternlogq   xmm3, xmm1, [bit52], 0xF2
    vmovsd       xmm4, [one]
