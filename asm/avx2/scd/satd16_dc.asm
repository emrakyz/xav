...
pd_2: times 8 dd 2
pw_8c: times 16 dw 4096

%macro SATD16_DC_SETUP 0
    lea     ss3q, [ssq*3]
    lea     src4q, [srcq+ssq*4]
%endmacro

%macro SATD16_DC_WHT 0
    ...
    vpmaddwd ymm10, ymm10, [pw_1]
    vpmaddwd ymm11, ymm11, [pw_1]
...
ALIGN 64
cglobal satd16_dc, 2, 4, 16, src, ss, src4, ss3
    SATD16_DC_SETUP
    vmovdqu ymm0, [srcq]
...
ALIGN 64
cglobal satd16_dc_s, 2, 4, 16, src, ss, src4, ss3
    SATD16_DC_SETUP
    vmovdqu ymm0, [srcq]
    vpsrlw ymm0, ymm0, 6
    vmovdqu ymm1, [srcq+ssq]
