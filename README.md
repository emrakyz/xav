...
- [ ] Add argument to output final metric scores to a specific JSON file and a summary to stdout, saving an additional execution of VSHip, or additional postprocessing of log files.
